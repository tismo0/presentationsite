...
<html lang="en">
    <head>
        ...
        <meta property="og:url" content="https://ayoubghrd.carrd.co"/>
        <meta property="twitter:card" content="summary_large_image"/>
        <link rel="canonical" href="https://ayoubghrd.carrd.co"/>
        <link href="https://fonts.googleapis.com/css2?display=swap&family=Lexend:ital,wght@0,400;0,700;1,400;1,700&family=Inria+Serif:ital,wght@0,400;0,700;1,400;1,700&family=Inter:ital,wght@0,400;0,700;1,400;1,700" rel="stylesheet" type="text/css"/>
        <style>
            ...
            *, *:before, *:after {
            ...
            #buttons01 .n03:hover {
                border-color: #7F0FA6 !important;
                color: #7F0FA6 !important;
            }

            #buttons01 .n03:hover svg {
                fill: #7F0FA6 !important;
            }
            ...
            #container01 {
                ...
                align-items: center;
                justify-content: center;
                background-image: url('data:image/svg+xml;charset=utf8,%3Csvg%20viewBox%3D%220%200%20512%20512%22%20width%3D%22512%22%20height%3D%22512%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%20%3Cfilter%20id%3D%22noise%22%3E%20%3CfeTurbulence%20type%3D%22fractalNoise%22%20baseFrequency%3D%220.875%22%20result%3D%22noise%22%20%2F%3E%20%3CfeColorMatrix%20type%3D%22matrix%22%20values%3D%220.1015625%200%200%200%200%200%200.09375%200%200%200%200%200%200.12890625%200%200%200%200%200%200.56640625%200%22%20%2F%3E%20%3C%2Ffilter%3E%20%3Crect%20filter%3D%22url%28%23noise%29%22%20x%3D%220%22%20y%3D%220%22%20width%3D%22512%22%20height%3D%22512%22%20fill%3D%22transparent%22%20opacity%3D%221%22%20%2F%3E%3C%2Fsvg%3E'), linear-gradient(265deg, #3A3647 0%, #303342 100%);
                background-size: 512px, cover;
                background-position: center, 0% 0%;
                background-repeat: repeat, repeat;
                box-shadow: 0rem 4.25rem 6.75rem 1.125rem rgba(48,51,66,0.49);
                border-radius: 2rem;
            }
                    ...
                    <div id="container01" class="container default">
                        <div class="wrapper">
                            <div class="inner" data-onvisible-trigger="1">
                                ...
                                <h1 id="text02">
                                    <em>
                                        <strong>Ayoub Ghrd</strong>
                                    </em>
                                </h1>
                                <p id="text01">
                                    <span class="p">
                                        ARV1,<br/>
                                        <a href="https://discord.gg/44rrtCJSaG">Serveur Discord</a>
                                        <br/>
                                        You can contribute to my <code>GitHub </code>
                                        projects using the button just below.
                                    </span>
                                </p>
                                ...
                                <ul id="buttons01" class="buttons">
                                    <li>
                                        <a href="https://www.instagram.com/ayoubghrd/" class="button n01" role="button">
                                            <svg aria-labelledby="buttons01-icon-1-title">
                                                <title id="buttons01-icon-1-title">Instagram</title>
                                    ...
                                    <li>
                                        <a href="https://www.tiktok.com/@ayoub_.msl" class="button n02" role="button">
                                            <svg aria-labelledby="buttons01-icon-2-title">
                                                <title id="buttons01-icon-2-title">TikTok</title>
                                    ...
                                    <li>
                                        <a href="https://discord.gg/44rrtCJSaG" class="button n03" role="button">
                                            <svg aria-labelledby="buttons01-icon-3-title">
                                                <title id="buttons01-icon-3-title">Discord</title>
                                                <use xlink:href="#icon-3b7eeeccbb457780f277fce4669f67a0"></use>
                                            </svg>
                                            <span class="label">My discord server</span>
                                        </a>
                                    </li>
                                </ul>
                                <ul id="icons01" class="icons">
                                    <li>
                                        <a class="n01" href="https://github.com/tismo0" role="button">
                                    ...
                                    <li>
                                        <a class="n02" href="/cdn-cgi/l/email-protection#a3c4daccd6c1cbe3c4cec2cacf8dc0ccce" role="button">
                                            <svg aria-labelledby="icons01-icon-2-title">
                                                <title id="icons01-icon-2-title">Email</title>
